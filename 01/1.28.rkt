...
; expmod procedure. However, whenever we perform the squaring step in expmod,
; we check to see if we have discovered a “nontrivial square root of 1 modulo
; n,” that is, a number not equal to 1 or n − 1 whose square is equal to 1
; modulo n.
;
...
(define TIMES 10)
(fast-prime? 273 TIMES) ; #f
(fast-prime? 561 TIMES) ; #f
(fast-prime? 7 TIMES)   ; #t
